...
#Class for tracking motion synthesizer. Keep feature points and blocks. 
class AllTracks:
    MOVING_SPEED = 2
    def __init__(self):
        self.point_tracks = []
...
#Feature tracking for objects of interest.
class PointTrack:
    next_id = 0
    max_len = 10
...
#Track and detect of object worth keeping.
class Object:
    tooYoung = 10
...
#building a synthesizer, help here.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--confidence', default=0.8 help='confidence level')   #Default to 80% confidence. Change as desired.
